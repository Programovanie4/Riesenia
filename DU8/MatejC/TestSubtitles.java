...
//		scoring.setScore("lang:common_list_test_scoring_name", 0, 100);
	...
	public void testSubtitles() throws FileNotFoundException {
		...
		List<List<String>> files = Arrays.asList(
				Arrays.asList(null, "UTF8",			// input1 - bez konverzie, jedna reklama
						"00:00:22,123 --> 00:02:27,623"),
				Arrays.asList(null, "Cp1250"),	// input2 - konverzia, bez reklamy
				Arrays.asList(null, "Cp1250",			// input3 - konverzia, s reklamami
